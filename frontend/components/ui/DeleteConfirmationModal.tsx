...
interface DeleteConfirmationModalProps {
  ...
  entityName: string; // e.g., "User", "Department", "Category"
  onClose: () => void;
  onConfirm: () => void;
  isLoading?: boolean;
}
    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4 shrink-0">
          <h2 className="text-lg font-bold text-red-600">Delete {entityName}(s)</h2>
          <button
            onClick={onClose}
            disabled={isLoading}
            ...
            <div>
              <h3 className="text-sm font-semibold text-secondary mb-2">
                ...
                {selectedCount === 1
                  ...
                  : `these ${selectedCount} ${entityName.toLowerCase()}s`}
                ?
              </h3>
