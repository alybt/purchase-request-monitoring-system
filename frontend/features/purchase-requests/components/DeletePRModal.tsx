    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full mx-4">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
          <h2 className="text-lg font-bold text-red-600">Delete PR(s)</h2>
          <button
            onClick={onClose}
            disabled={isLoading}
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h3 className="text-sm font-semibold text-secondary mb-2">
                ...
                {selectedCount === 1 ? "this PR" : `these ${selectedCount} PRs`}
                ?
              </h3>
              <p className="text-sm text-secondary/70">
                This action cannot be undone. All associated PR data will be
