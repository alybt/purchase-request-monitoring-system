...
export type StatusAction = "Approved" | "Rejected" | "Received" | "Released" | "Completed";
...
export default function StatusConfirmationModal({
  ...
  const actionConfig: Record<string, any> = {
    Approved: {
      ...
      description: "You are about to approve this Purchase Request. Once approved, it can proceed to procurement.",
    ...
    Rejected: {
      ...
      description: "Rejecting this Purchase Request will stop the approval process. The Department Head will be notified.",
      remarksLabel: "Remarks",
      remarksHelper: "Providing a reason helps the requesting department understand the decision.",
    ...
    Received: {
      ...
      description: "Confirm that all ordered items have been received from the supplier.",
      remarksLabel: "Remarks",
      remarksHelper: "Remarks are optional.",
    ...
    Released: {
      ...
      title: "Release Items",
      description: "Confirm that the received items have been released to the requesting department.",
      remarksLabel: "Remarks",
      remarksHelper: "Remarks are optional.",
    ...
    Completed: {
      ...
      description: "Confirm that your department has successfully received the released items. This will complete the Purchase Request.",
      remarksLabel: "Remarks",
      remarksHelper: "Remarks are optional.",
      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="p-8 pb-6 flex flex-col items-center text-center">
            {/* Icon */}
            <div className={`p-4 rounded-full ${config.bgIcon} ${config.textIcon} mb-5 shadow-sm`}>
              {config.icon}
            </div>
          ...
          <div className="px-8 pb-8 space-y-2">
            <label className="block text-sm font-semibold text-secondary">
              {config.remarksLabel} <span className="text-slate-400 font-normal">(Optional)</span>
            </label>
            <textarea
              value={remarks}
              ...
              autoFocus
            />
            <p className="text-xs text-slate-400 pl-1">{config.remarksHelper}</p>
          </div>
